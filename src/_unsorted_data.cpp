...
const char *custom_missions_in_game_briefing[20] =
{
    "FRESH MEAT\nThough it makes me shiver to my soul,\nI sense that the Symmetrics have made\ntheir presence felt near one of our\ncamps.\nClear their sorry, Symmetric selves\nfrom the land.",
    "THE AMEOBA\nOur prosperous war camp is coming under\nthreat - the Symmetrics are gathering\ntheir forces, and we fear the results.\nOur big camp, though prosperous, is too\ndistant from the enemy, so you must set\nup another camp and deal with the enemy\nin close quarters.",
    "THE GAUNTLET\nWe have the Symmetrics backed into a\ndefended valley.  They are cringing and\nwill soon beg for mercy.  We need you\nto enter the valley through its only\nentrance and show the enemy none of\nthis mercy.  Let them taste what a\nsecond Scourge would be like.",
    "STAND AND FIGHT\nWe keep weeding out the foul Symmetrics\nand, just like weeds, they keep\nreturning.  This time they pester one\nof our camps like pests.\nExterminate them.",
    "THE PROPHECY\nI feel a disturbance in the... well,\njust a disturbance.  I fear that an\nenormous attack from the Symmetrics is\nin the making.  I cannot be sure.\nI feel that you should build up\ndefenses that can withstand just such\nan attack, should it eventuate.",
    "TRAITORS\nAlas, one of our Chieftains has fallen\nill to the Scourge sickness.  His mind\nbetrays him as it betrays us - he has\nmade a pact with the Symmetrics!  His\nloyal clan follows him, and the two\ngroups now fight as one.  He must be\nbrought into alignment with his spirit\nonce again.",
    "THE PURSUIT\nWe are a peaceful people.  All we wish\nis to set up our homes and help prevent\nthe Earth from further damage.  But the\nSymmetrics won't let us.  Even now,\nthey pursue and harass a convoy which\nonly wants to set up a war camp.  Use\nour head start to complete the camp's\nset-up, then annihilate the enemy.",
    "HIVE MIND\nThe enemy is falling to its\nclaustrophobic nature - they have set\nup their supply lines in a valley.\nIt's time to attack from the heavens\n- use our glorious Thunder Wasps to\naccomplish this task.",
    "BOMBARDMENT\nThe creatures stir.  They hear sounds\non the horizon, and I fear it is the\nSymmetric's own heavenly attack - the\nmetal birds.  Or it could be a Wilbur\nBomber Air Strike.  Whatever it is,\nprepare for it, survive it, then hunt\ndown the enemy and destroy them for\ndaring to use our skies for themselves.",
    "HAND OF GOD\nAs we speak, our glorious warriors and\nbeasts surround a Symmetric base.  Our\nanimals grow excited at the smell of\nsoiled uniforms.  Using all of our\nforces, tighten your grip on the base\nand crush it, destroying everything.",
    "SQUISH\nAn unsightly Freaker village has sprung\nup near one of our pristine, high-tech\nencampments.  Even if it's just for the\npure aesthetics of it all, go in there\nand take out the garbage.",
    "COUNTER-ATTACK\nThose mutants failed at their ambush,\nand we want them to fail even more.\nWe've traced them back to their pitiful\ncamp.  You know what to do.",
    "DISTRESS\nOur people in Communications have\npicked up a distress signal.\nThe signal is coming from a bunker\nin the badlands.  I don't know\nexactly what some of our highest\nranking leaders were doing in the\nbadlands in the first place, but that's\nwhere you have to go to rescue them.",
    "TRICKLE FEED\nWhat's happened is some joker changed\neveryone's watches, so instead of\nhaving a big force to trash a Freak\ncamp, you've initially only got a\nlittle force.  Over the course of the\nmission, your reinforcements will\ntrickle in as their watches catch up -\nhopefully, you won't be dead by then.",
    "S.O.S.\nWe've got a small base, and generally\nsize doesn't count.  But not this time.\nThis time, we've got a small base, the\nFreaks have got a large one, and we're\nin trouble.  Your mission is to hold off\nthose freaky little dung people.\nReinforcements are on the way from a\nSurvivor camp 15 minutes away.",
    "BUG HUNT\nWe've lost communications with an\nisolated base, Commander, and we want\nyou to deal with it.  Fix what\nneeds to be fixed and deal with\nwhatever needs to be dealt with.",
    "THE INFILTRATOR\nThe enemy know we're here, and they're\ngoing to expect a big, crushing attack\nwhich could easily wipe them off this\npart of our world.  But we're not going\nto play their little game.  We're going\nto send one single sniper with one gun\nand no armour to clear the whole damn\narea. That'll show 'em.",
    "JAIL BREAK\nIt's rescue time again, Commander.  One\nof our patrols was captured by a mutant\nambush.  There's no telling how long\nit'll be before the Freaks start\nperforming some crazy death ceremony or\nother.  We want you to get in there and\nrescue the captured patrol.",
    "WAGONS HO\nThose filthy Freaks have taken to the\nhigh ground and they're stinking up all\nthe valleys around them.  And they're\nkilling people, which is a bad thing as\nwell.  Hold your nose while you hunt\nthem down and kill them.",
    "TAG TEAM\nOne of our little bases is under\nconstant attack.  The base is in a\ntight position and it can't be expanded\nenough to eradicate those Freaks.  Take\na Mobile Outpost and set it up\nsomewhere spacious, then build up your\narmy. Join forces with the original\nlittle camp and squash the Freaks.",
};
char *aW = "w";
...
int __477318_beastenclosure_negindex[5] = { 0, 0, 0, 0, 0 }; // weak
